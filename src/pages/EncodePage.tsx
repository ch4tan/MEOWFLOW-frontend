...
const EncodePage = () => {
    ...
    const triggerEncode = async (): Promise<void> => {
        try {
            setError("");
            setCopy("");
    ...
    return (
        <div className="flex flex-col h-full w-full items-center bg-[#EA925E] font-playfair border-b-2 border-t-2 text-white">
            <h1 className="font-bitcount pt-10 text-4xl md:text-7xl text-[#EBE3F5]">Encoder</h1>
            ...
            <div className="grid maxmd:grid-rows-2 md:grid-cols-2 w-full h-full">
                <div className="flex flex-col w-full h-full justify-center items-center gap-5">
                    ...
                    />
                    <button onClick={() => triggerEncode()} className="bg-[#B13026] w-20 md:h-8 rounded-3xl md:hover:scale-125 md:hover:shadow-md md:hover:shadow-black">ENCODE</button>
                </div>
